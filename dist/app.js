...
var _mfeineis$elm_design_insights$Data_Commit$decodeDate = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (s) {
...
var _mfeineis$elm_design_insights$Data_Commit$decodeBody = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (_p1) {
...
var _mfeineis$elm_design_insights$Data_Commit$decodeMaybeBool = function (name) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (_p2) {
			return _elm_lang$core$Json_Decode$succeed(
				A2(_elm_lang$core$Maybe$withDefault, false, _p2));
		},
		_elm_lang$core$Json_Decode$maybe(
			A2(_elm_lang$core$Json_Decode$field, name, _elm_lang$core$Json_Decode$bool)));
};
var _mfeineis$elm_design_insights$Data_Commit$Meta = F8(
	function (a, b, c, d, e, f, g, h) {
		return {byPivotalAuthor: a, elm_0_14_design: b, elm_0_15_design: c, elm_0_16_design: d, elm_0_17_design: e, elm_0_18_design: f, elm_0_19_design: g, mightBeInteresting: h};
	});
var _mfeineis$elm_design_insights$Data_Commit$decodeMeta = A9(
	_elm_lang$core$Json_Decode$map8,
	_mfeineis$elm_design_insights$Data_Commit$Meta,
	A2(_elm_lang$core$Json_Decode$field, 'byPivotalAuthor', _elm_lang$core$Json_Decode$bool),
	A2(_elm_lang$core$Json_Decode$field, 'elm_0_14_design', _elm_lang$core$Json_Decode$bool),
	A2(_elm_lang$core$Json_Decode$field, 'elm_0_15_design', _elm_lang$core$Json_Decode$bool),
	A2(_elm_lang$core$Json_Decode$field, 'elm_0_16_design', _elm_lang$core$Json_Decode$bool),
	A2(_elm_lang$core$Json_Decode$field, 'elm_0_17_design', _elm_lang$core$Json_Decode$bool),
	A2(_elm_lang$core$Json_Decode$field, 'elm_0_18_design', _elm_lang$core$Json_Decode$bool),
	A2(_elm_lang$core$Json_Decode$field, 'elm_0_19_design', _elm_lang$core$Json_Decode$bool),
	_mfeineis$elm_design_insights$Data_Commit$decodeMaybeBool('mightBeInteresting'));
var _mfeineis$elm_design_insights$Data_Commit$Commit = F8(
	function (a, b, c, d, e, f, g, h) {
		return {authorName: a, body: b, date: c, meta: d, repoName: e, repoUrl: f, sha: g, summary: h};
	});
var _mfeineis$elm_design_insights$Data_Commit$decoder = A9(
	_elm_lang$core$Json_Decode$map8,
	_mfeineis$elm_design_insights$Data_Commit$Commit,
	A2(_elm_lang$core$Json_Decode$field, 'authorName', _elm_lang$core$Json_Decode$string),
	_mfeineis$elm_design_insights$Data_Commit$decodeBody,
	A2(_elm_lang$core$Json_Decode$field, 'date', _mfeineis$elm_design_insights$Data_Commit$decodeDate),
	A2(_elm_lang$core$Json_Decode$field, 'meta', _mfeineis$elm_design_insights$Data_Commit$decodeMeta),
	A2(_elm_lang$core$Json_Decode$field, 'repoName', _elm_lang$core$Json_Decode$string),
...
var _mfeineis$elm_design_insights$Data_Commit$listDecoder = _elm_lang$core$Json_Decode$list(_mfeineis$elm_design_insights$Data_Commit$decoder);
...
var _mfeineis$elm_design_insights$View$mapMonth = function (month) {
	var _p0 = month;
	switch (_p0.ctor) {
		case 'Jan':
			return 1;
...
var _mfeineis$elm_design_insights$View$renderDate = function (date) {
	var min = A3(
	...
	var month = A3(
		...
		_elm_lang$core$Native_Utils.chr('0'),
		_elm_lang$core$Basics$toString(
			_mfeineis$elm_design_insights$View$mapMonth(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								hour,
								A2(_elm_lang$core$Basics_ops['++'], ':', min))))))));
};
var _mfeineis$elm_design_insights$View$pageFrame = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
	_rtfeldman$elm_css$Html_Styled$div,
	{ctor: '[]'});
var _mfeineis$elm_design_insights$View$withCssReset = function (content) {
	return A2(
		_mfeineis$elm_design_insights$View$pageFrame,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A3(
			...
			_1: {
				...
				_0: A3(
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Attributes$href('https://fonts.googleapis.com/css?family=Roboto'),
						_1: {
							ctor: '::',
...
var _mfeineis$elm_design_insights$View$serialNumber = F2(
	function (all, index) {
		var allLength = _elm_lang$core$String$length(
...
var _mfeineis$elm_design_insights$View$commitBody = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
	_rtfeldman$elm_css$Html_Styled$div,
	{ctor: '[]'});
var _mfeineis$elm_design_insights$View$commitContent = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
	_rtfeldman$elm_css$Html_Styled$div,
	{
		ctor: '::',
...
var _mfeineis$elm_design_insights$View$authorName = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
	_rtfeldman$elm_css$Html_Styled$span,
	{
		ctor: '::',
...
var _mfeineis$elm_design_insights$View$makeCommitUrl = function (commit) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		commit.repoUrl,
		A2(_elm_lang$core$Basics_ops['++'], '/commit/', commit.sha));
};
var _mfeineis$elm_design_insights$View$commitSummary = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
	_rtfeldman$elm_css$Html_Styled$span,
	{
		ctor: '::',
...
var _mfeineis$elm_design_insights$View$commitList = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
...
var _mfeineis$elm_design_insights$View$renderToast = function (toast) {
	return {
		ctor: '::',
		_0: _rtfeldman$elm_css$Html_Styled$text(toast),
		_1: {ctor: '[]'}
	};
};
var _mfeineis$elm_design_insights$View$empty = _rtfeldman$elm_css$Html_Styled$text('');
var _mfeineis$elm_design_insights$View$text = _rtfeldman$elm_css$Html_Styled$text;
var _mfeineis$elm_design_insights$View$theme = {
	border: A3(
		_rtfeldman$elm_css$Css$border3,
		_rtfeldman$elm_css$Css$px(1),
		_rtfeldman$elm_css$Css$solid,
		_rtfeldman$elm_css$Css$hex('#888888')),
	borderColor: _rtfeldman$elm_css$Css$hex('#888888'),
	borderRadius: _rtfeldman$elm_css$Css$px(3),
	primaryColor: A3(_rtfeldman$elm_css$Css$rgb, 96, 181, 204),
	width: _rtfeldman$elm_css$Css$px(800)
};
var _mfeineis$elm_design_insights$View$pageTitle = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
	_rtfeldman$elm_css$Html_Styled$h1,
	{
		...
		_1: {
			ctor: '::',
			_0: _rtfeldman$elm_css$Css$maxWidth(_mfeineis$elm_design_insights$View$theme.width),
			_1: {
				ctor: '::',
...
var _mfeineis$elm_design_insights$View$pageSubTitle = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
...
var _mfeineis$elm_design_insights$View$renderHeader = function (model) {
	return {
		ctor: '::',
		_0: A2(
			_mfeineis$elm_design_insights$View$pageTitle,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled$text('Potentially Interesting Commits to Elm Core Packages'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: _elm_lang$core$List$isEmpty(model.commits) ? _rtfeldman$elm_css$Html_Styled$text('') : A2(
				_mfeineis$elm_design_insights$View$pageSubTitle,
				{ctor: '[]'},
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled$text(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(
									_elm_lang$core$List$length(model.commits)),
								' commits'))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _elm_lang$core$List$isEmpty(model.toasts) ? _rtfeldman$elm_css$Html_Styled$text('') : A2(
					_rtfeldman$elm_css$Html_Styled$ul,
					{ctor: '[]'},
					A2(
						_elm_lang$core$List$map,
						function (_p1) {
							return A2(
								...
								{ctor: '[]'},
								_mfeineis$elm_design_insights$View$renderToast(_p1));
						},
						model.toasts)),
				_1: {ctor: '[]'}
			}
...
var _mfeineis$elm_design_insights$View$abstract = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
	_rtfeldman$elm_css$Html_Styled$div,
	{
		ctor: '::',
...
var _mfeineis$elm_design_insights$View$renderFooter = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
	_rtfeldman$elm_css$Html_Styled$div,
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$color(_mfeineis$elm_design_insights$View$theme.borderColor),
		_1: {
			ctor: '::',
			_0: A2(
				_rtfeldman$elm_css$Css$margin2,
...
var _mfeineis$elm_design_insights$View$footerLink = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
	_rtfeldman$elm_css$Html_Styled$a,
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$color(_mfeineis$elm_design_insights$View$theme.primaryColor),
		_1: {
			ctor: '::',
			_0: _rtfeldman$elm_css$Css$display(_rtfeldman$elm_css$Css$inlineBlock),
			_1: {
...
var _mfeineis$elm_design_insights$View$spinner = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
	_rtfeldman$elm_css$Html_Styled$div,
	{
		ctor: '::',
...
var _mfeineis$elm_design_insights$View$elmVersionLabel = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
	_rtfeldman$elm_css$Html_Styled$span,
	{
		ctor: '::',
		_0: _mfeineis$elm_design_insights$View$theme.border,
		_1: {
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$borderRadius(_mfeineis$elm_design_insights$View$theme.borderRadius),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$display(_rtfeldman$elm_css$Css$inlineBlock),
					_1: {
...
var _mfeineis$elm_design_insights$View$renderElmVersion = function (meta) {
	return meta.elm_0_19_design ? A2(
		_mfeineis$elm_design_insights$View$elmVersionLabel,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled$text('Elm 0.19'),
			_1: {ctor: '[]'}
		}) : (meta.elm_0_18_design ? A2(
		_mfeineis$elm_design_insights$View$elmVersionLabel,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled$text('Elm 0.18'),
			_1: {ctor: '[]'}
		}) : (meta.elm_0_17_design ? A2(
		_mfeineis$elm_design_insights$View$elmVersionLabel,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled$text('Elm 0.17'),
			_1: {ctor: '[]'}
		}) : (meta.elm_0_16_design ? A2(
		_mfeineis$elm_design_insights$View$elmVersionLabel,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled$text('Elm 0.16'),
			_1: {ctor: '[]'}
		}) : (meta.elm_0_15_design ? A2(
		_mfeineis$elm_design_insights$View$elmVersionLabel,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled$text('Elm 0.15'),
			_1: {ctor: '[]'}
		}) : (meta.elm_0_14_design ? A2(
		_mfeineis$elm_design_insights$View$elmVersionLabel,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled$text('Elm 0.14'),
			_1: {ctor: '[]'}
		}) : A2(
		_mfeineis$elm_design_insights$View$elmVersionLabel,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled$text('Ancient'),
			_1: {ctor: '[]'}
		}))))));
};
var _mfeineis$elm_design_insights$View$repoNameLabel = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
	_rtfeldman$elm_css$Html_Styled$span,
	{
		ctor: '::',
...
var _mfeineis$elm_design_insights$View$commitLink = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
	_rtfeldman$elm_css$Html_Styled$a,
	{
		ctor: '::',
...
var _mfeineis$elm_design_insights$View$commitItem = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
	_rtfeldman$elm_css$Html_Styled$li,
	{
		ctor: '::',
...
var _mfeineis$elm_design_insights$View$commitHeader = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
	_rtfeldman$elm_css$Html_Styled$div,
	{
		ctor: '::',
		...
		_1: {
			...
			_0: A3(
				...
				_rtfeldman$elm_css$Css$px(1),
				_rtfeldman$elm_css$Css$solid,
				_mfeineis$elm_design_insights$View$theme.borderColor),
			_1: {
				ctor: '::',
				_0: _rtfeldman$elm_css$Css$borderTopLeftRadius(_mfeineis$elm_design_insights$View$theme.borderRadius),
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Css$borderTopRightRadius(_mfeineis$elm_design_insights$View$theme.borderRadius),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$paddingBottom(
							_rtfeldman$elm_css$Css$px(10)),
...
var _mfeineis$elm_design_insights$View$repoLink = A2(
	_rtfeldman$elm_css$Html_Styled$styled,
	_rtfeldman$elm_css$Html_Styled$a,
	{
		ctor: '::',
...
var _mfeineis$elm_design_insights$View$renderCommit = F3(
	function (all, index, commit) {
		return A2(
			_mfeineis$elm_design_insights$View$commitItem,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: A2(
					_mfeineis$elm_design_insights$View$commitHeader,
					{ctor: '[]'},
					{
						ctor: '::',
						_0: A2(_mfeineis$elm_design_insights$View$serialNumber, all, index),
						_1: {
							ctor: '::',
							_0: A2(
								_mfeineis$elm_design_insights$View$commitLink,
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled_Attributes$href(
										_mfeineis$elm_design_insights$View$makeCommitUrl(commit)),
									_1: {
										ctor: '::',
								...
								},
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled$text(
										_mfeineis$elm_design_insights$View$renderDate(commit.date)),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									_mfeineis$elm_design_insights$View$repoNameLabel,
									{ctor: '[]'},
									{
										ctor: '::',
										_0: A2(
											_mfeineis$elm_design_insights$View$repoLink,
											{
												ctor: '::',
												_0: _rtfeldman$elm_css$Html_Styled_Attributes$href(commit.repoUrl),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _rtfeldman$elm_css$Html_Styled$text(commit.repoName),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										_mfeineis$elm_design_insights$View$authorName,
										{ctor: '[]'},
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Html_Styled$text(commit.authorName),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: _mfeineis$elm_design_insights$View$renderElmVersion(commit.meta),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				_1: {
					ctor: '::',
					_0: A2(
						_mfeineis$elm_design_insights$View$commitContent,
						{ctor: '[]'},
						{
							ctor: '::',
							_0: A2(
								_mfeineis$elm_design_insights$View$commitSummary,
								{ctor: '[]'},
								{
									ctor: '::',
									_0: _rtfeldman$elm_css$Html_Styled$text(commit.summary),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									_mfeineis$elm_design_insights$View$commitBody,
									{ctor: '[]'},
									{
										ctor: '::',
...
var _mfeineis$elm_design_insights$View$renderCommitList = function (commits) {
	return {
		ctor: '::',
		_0: A2(
			_mfeineis$elm_design_insights$View$commitList,
			{ctor: '[]'},
			A2(
				_elm_lang$core$List$indexedMap,
				_mfeineis$elm_design_insights$View$renderCommit(
...
var _mfeineis$elm_design_insights$Main$view = function (model) {
	var commitList = _elm_lang$core$List$isEmpty(model.commits) ? {
		ctor: '::',
		_0: A2(
			_mfeineis$elm_design_insights$View$spinner,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: _mfeineis$elm_design_insights$View$text('Please stand by, this might take a moment...'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	} : _mfeineis$elm_design_insights$View$renderCommitList(model.commits);
	var footer = {
		ctor: '::',
		_0: A2(
			_mfeineis$elm_design_insights$View$renderFooter,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: _mfeineis$elm_design_insights$View$text('View powered by Elm'),
				_1: {
					ctor: '::',
					_0: A2(
						_mfeineis$elm_design_insights$View$footerLink,
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Attributes$href('https://github.com/mfeineis/elm-design-insights'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _mfeineis$elm_design_insights$View$text('https://github.com/mfeineis/elm-design-insights'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
	...
	var lastUpdated = A2(
		...
		_elm_lang$core$List$head(
			_elm_lang$core$List$reverse(model.commits)));
	var $abstract = {
		ctor: '::',
		_0: A2(
			_mfeineis$elm_design_insights$View$abstract,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: _mfeineis$elm_design_insights$View$text('\n                    This page shows all commits to Elm core package repositories\n                    that may contain interesting thoughts and decisions regarding the\n                    design process of the Elm language. Note that this is not a live\n                    list but is sporadically generated and served statically.\n                    '),
				_1: {
					ctor: '::',
					_0: function () {
						var _p0 = lastUpdated;
						if (_p0.ctor === 'Just') {
							return _mfeineis$elm_design_insights$View$text(
								A2(
									_elm_lang$core$Basics_ops['++'],
									'Last tracked commit timestamp is ',
									_mfeineis$elm_design_insights$View$renderDate(_p0._0)));
						} else {
							return _mfeineis$elm_design_insights$View$empty;
						}
					}(),
					_1: {ctor: '[]'}
				}
	...
	var header = _mfeineis$elm_design_insights$View$renderHeader(model);
	return _mfeineis$elm_design_insights$View$withCssReset(
		A2(
			_elm_lang$core$Basics_ops['++'],
			header,
			A2(
				_elm_lang$core$Basics_ops['++'],
				$abstract,
				A2(_elm_lang$core$Basics_ops['++'], footer, commitList))));
};
var _mfeineis$elm_design_insights$Main$update = F2(
	function (msg, model) {
		var filterCommit = function (commit) {
			return commit.meta.mightBeInteresting;
		};
		var _p1 = msg;
		if (_p1._0.ctor === 'Ok') {
			var interesting = A2(_elm_lang$core$List$filter, filterCommit, _p1._0._0);
			return {
				ctor: '_Tuple2',
...
var _mfeineis$elm_design_insights$Main$Flags = {};
var _mfeineis$elm_design_insights$Main$Model = F2(
	function (a, b) {
		return {commits: a, toasts: b};
	});
var _mfeineis$elm_design_insights$Main$CommitsReceived = function (a) {
	return {ctor: 'CommitsReceived', _0: a};
};
var _mfeineis$elm_design_insights$Main$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: {
			commits: {ctor: '[]'},
		...
		_1: A2(
			...
			_mfeineis$elm_design_insights$Main$CommitsReceived,
			A2(_elm_lang$http$Http$get, '/dist/result-latest.json', _mfeineis$elm_design_insights$Data_Commit$listDecoder))
	};
};
var _mfeineis$elm_design_insights$Main$main = _elm_lang$html$Html$program(
	{
		init: _mfeineis$elm_design_insights$Main$init(
			{}),
		subscriptions: function (_p2) {
			return _elm_lang$core$Platform_Sub$none;
		},
		update: _mfeineis$elm_design_insights$Main$update,
		view: function (_p3) {
			return _rtfeldman$elm_css$Html_Styled$toUnstyled(
				_mfeineis$elm_design_insights$Main$view(_p3));
		}
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _mfeineis$elm_design_insights$Main$main !== 'undefined') {
    _mfeineis$elm_design_insights$Main$main(Elm['Main'], 'Main', undefined);
}
